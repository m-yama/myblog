...
# `ablog start` on Sun May 15 01:24:48 2016.
#
...
html_theme_options = {
    ...
    'github_user': 'm-yama',
    'github_repo': 'myblog',
    'font_family': u"Avenir, Roboto, 'ヒラギノ角ゴ Pro', 'Hiragino Kaku Gothic Pro', 'メイリオ', Meiryo, Osaka, 'MS PGothic', arial, helvetica, sans-serif",
    'font_size': '16px',
    'head_font_family': u"Avenir, Roboto, 'ヒラギノ角ゴ Pro', 'Hiragino Kaku Gothic Pro', 'メイリオ', Meiryo, Osaka, 'MS PGothic', arial, helvetica, sans-serif",
}
